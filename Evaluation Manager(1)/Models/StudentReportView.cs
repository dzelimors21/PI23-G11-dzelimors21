...
namespace Evaluation_Manager.Models {
    public class StudentReportView {
        ...
        public StudentReportView(Student student) {
            ...
            var kolokvij1 = evaluations.FirstOrDefault(e => e.Activity.Name == "Kolokvij 1"); //funkcionira kao for petlja, e (ili bilo koje drugo slovo) je element u listi - filtriramo po listi - vrati e za kojeg vrijedi da je naziv aktivnosti kolokvij 1
            ...
            Z3 = zadaca3 == null ? "-" : zadaca3.Points.ToString(); //ako je zadaca 3 jednaka NULL vrati crticu, inace vrati bodove iz zadace 3
        }
    }
}
